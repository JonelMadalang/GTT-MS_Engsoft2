@extends('layouts.admin_app')
  ...
  <table id="nonDrivers-tbl" class="table table-dark">
    <thead>
    <tr>
      <!-- <th scope="col">ID:</th> -->
    ...
    <tr>
      ...
      <td>{{$user->birthday}}</td>
      <td></td>
      <td><button id ="assignTaxiBtn" data_id="{{$user->id}}" class="btn btn-outline-success" type="button">Assign Taxi</button></td>
    </tr>
    @endforeach
